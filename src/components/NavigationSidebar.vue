<template>
  <nav class="sidebar-nav">
    ...
    <button class="sidebar-btn icon-btn top-btn" @click="$emit('toggle-sidebar')">
      <svg width="100" height="100" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" fill="#34A4EE">
    ...
    <button class="sidebar-btn icon-btn top-btn" @click="$emit('tienda-click')"> <!--Botón de predicciones por tienda-->
      <svg data-name="Layer 1" id="Layer_1" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" fill="#34A4EE">
        <title/>
    ...
    <button class="sidebar-btn icon-btn top-btn" @click="$emit('temporada-click')"> <!--Botón de predicciones por temporada-->
      <svg data-name="Layer 2" id="a866a81f-2948-4418-8bd5-1a5193c5f74e" viewBox="0 0 35 35" xmlns="http://www.w3.org/2000/svg" fill="#34A4EE">
